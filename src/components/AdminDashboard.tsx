...
const STATIC_SERVICE_PACKAGES = [
  ...
  { tabCategory: 'social-content', tabLabel: 'Social & Content', serviceSection: 'Social Media Content Shoots', name: 'Social Content – Full Service', price: '$3,250*', badge: '', includes: ['Full-day production coverage', 'Up to 3 edited vertical reels', '60 edited photo selects', 'Pre-production planning', 'Priority editing workflow', 'Best for launches and campaign-style social content'], image: 'https://images.pexels.com/photos/20413045/pexels-photo-20413045.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Built for brands that need scroll-stopping content for Instagram, TikTok, paid social, and web.' },
  { tabCategory: 'social-content', tabLabel: 'Social & Content', serviceSection: 'Headshots, Portraits & Studio Photography', name: 'Headshots & Portraits – Basic', price: '$395*', badge: '', includes: ['Up to 30 minutes', '1 look', '1 retouched final image', 'Private proof gallery'], image: 'https://images.pexels.com/photos/6722641/pexels-photo-6722641.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Professional, polished imagery for founders, teams, talent, and personal brands.' },
  ...
  { tabCategory: 'social-content', tabLabel: 'Social & Content', serviceSection: 'Headshots, Portraits & Studio Photography', name: 'Headshots & Portraits – Full Service', price: '$1,195*', badge: '', includes: ['Up to 90 minutes', '3 to 4 looks', '6 retouched final images', 'Creative direction throughout session', 'Priority turnaround'], image: 'https://images.pexels.com/photos/6722641/pexels-photo-6722641.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Professional, polished imagery for founders, teams, talent, and personal brands.' },
  // Events & Hospitality
  { tabCategory: 'events-hospitality', tabLabel: 'Events & Hospitality', serviceSection: 'Event Coverage', name: 'Event Coverage – Basic', price: '$850*', badge: '', includes: ['Up to 2 hours of coverage', '50+ edited images', 'Online gallery delivery'], image: 'https://images.pexels.com/photos/35367317/pexels-photo-35367317.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Refined event photography for launches, private gatherings, corporate events, dinners, and brand activations.' },
  { tabCategory: 'events-hospitality', tabLabel: 'Events & Hospitality', serviceSection: 'Event Coverage', name: 'Event Coverage – Standard', price: '$1,450*', badge: 'Most Popular', includes: ['Up to 4 hours of coverage', '125+ edited images', 'Online gallery delivery', 'Ideal for brand events, dinners, and networking events'], image: 'https://images.pexels.com/photos/35367317/pexels-photo-35367317.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Refined event photography for launches, private gatherings, corporate events, dinners, and brand activations.' },
  { tabCategory: 'events-hospitality', tabLabel: 'Events & Hospitality', serviceSection: 'Event Coverage', name: 'Event Coverage – Full Service', price: '$2,650*', badge: '', includes: ['Up to 8 hours of coverage', '250+ edited images', '24-hour preview selects', 'Full event storytelling coverage'], image: 'https://images.pexels.com/photos/35367317/pexels-photo-35367317.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Refined event photography for launches, private gatherings, corporate events, dinners, and brand activations.' },
