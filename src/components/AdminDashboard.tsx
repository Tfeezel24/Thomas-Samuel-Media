...
const STATIC_SERVICE_PACKAGES = [
  // Brand & Commercial
  { tabCategory: 'brand-commercial', tabLabel: 'Brand & Commercial', serviceSection: 'Brand & Promotional Photography', name: 'Brand & Promo Photography – Basic', price: '$1,250*', badge: '', includes: ['Up to 2 hours', '1 location or setup', '20 edited images'], image: 'https://images.pexels.com/photos/15380337/pexels-photo-15380337.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Elevated visual storytelling for founders, teams, service businesses, launches, and lifestyle-driven marketing.' },
  { tabCategory: 'brand-commercial', tabLabel: 'Brand & Commercial', serviceSection: 'Brand & Promotional Photography', name: 'Brand & Promo Photography – Standard', price: '$2,200*', badge: 'Most Popular', includes: ['Up to 4 hours', 'Up to 2 locations or multiple setups', '40 edited images', '1 edited vertical reel'], image: 'https://images.pexels.com/photos/15380337/pexels-photo-15380337.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Elevated visual storytelling for founders, teams, service businesses, launches, and lifestyle-driven marketing.' },
  { tabCategory: 'brand-commercial', tabLabel: 'Brand & Commercial', serviceSection: 'Brand & Promotional Photography', name: 'Brand & Promo Photography – Full Service', price: '$3,800*', badge: '', includes: ['Up to 8 hours', 'Multiple scenes and creative variations', '60+ edited images', '2 edited vertical reels', 'Pre-production planning'], image: 'https://images.pexels.com/photos/15380337/pexels-photo-15380337.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Elevated visual storytelling for founders, teams, service businesses, launches, and lifestyle-driven marketing.' },
  { tabCategory: 'brand-commercial', tabLabel: 'Brand & Commercial', serviceSection: 'Product Photography', name: 'Product Photography – Basic', price: '$1,250*', badge: '', includes: ['Half-day shoot', 'Simple styling and clean setup', 'Up to 15 final edited images', 'Basic retouching'], image: 'https://images.pexels.com/photos/3065075/pexels-photo-3065075.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Clean, elevated product imagery for e-commerce, launches, ads, and brand storytelling.' },
  { tabCategory: 'brand-commercial', tabLabel: 'Brand & Commercial', serviceSection: 'Product Photography', name: 'Product Photography – Standard', price: '$2,400*', badge: 'Most Popular', includes: ['Full-day shoot', 'Multiple setups, angles, and variations', 'Up to 30 final edited images', 'Advanced retouching'], image: 'https://images.pexels.com/photos/3065075/pexels-photo-3065075.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Clean, elevated product imagery for e-commerce, launches, ads, and brand storytelling.' },
  { tabCategory: 'brand-commercial', tabLabel: 'Brand & Commercial', serviceSection: 'Product Photography', name: 'Product Photography – Full Service', price: '$3,600*', badge: '', includes: ['Full-day production with expanded creative direction', 'Styled scenes and multiple concepts', 'Up to 45 final edited images', 'Ideal for launches, campaigns, and larger product lines'], image: 'https://images.pexels.com/photos/3065075/pexels-photo-3065075.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Clean, elevated product imagery for e-commerce, launches, ads, and brand storytelling.' },
  { tabCategory: 'brand-commercial', tabLabel: 'Brand & Commercial', serviceSection: 'Brand Campaign Day Rates', name: 'Brand Campaign – Half-Day', price: '$2,500*', badge: '', includes: ['Up to 4 hours production', 'Creative direction', 'Photo or hybrid photo/video capture'], image: 'https://images.pexels.com/photos/36287813/pexels-photo-36287813.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'For larger commercial productions, ad campaigns, product launches, and multi-deliverable shoots.' },
  { tabCategory: 'brand-commercial', tabLabel: 'Brand & Commercial', serviceSection: 'Brand Campaign Day Rates', name: 'Brand Campaign – Full Day', price: '$4,500*', badge: 'Most Popular', includes: ['Up to 8 hours production', 'Creative direction and shot planning', 'Photo or hybrid photo/video capture', 'Best for launches and multi-platform campaigns'], image: 'https://images.pexels.com/photos/36287813/pexels-photo-36287813.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'For larger commercial productions, ad campaigns, product launches, and multi-deliverable shoots.' },
  // Social & Content
  { tabCategory: 'social-content', tabLabel: 'Social & Content', serviceSection: 'Social Media Content Shoots', name: 'Social Content – Basic', price: '$1,250*', badge: '', includes: ['Up to 4 hours on-site', '1 location', '1 edited vertical reel', '20 edited photo selects', 'Light creative direction and shot planning', 'Organic social and web use'], image: 'https://images.pexels.com/photos/33410864/pexels-photo-33410864.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Built for brands that need scroll-stopping content for Instagram, TikTok, paid social, and web.' },
  ...
  { tabCategory: 'social-content', tabLabel: 'Social & Content', serviceSection: 'Social Media Content Shoots', name: 'Social Content – Full Service', price: '$3,250*', badge: '', includes: ['Full-day production coverage', 'Up to 3 edited vertical reels', '60 edited photo selects', 'Pre-production planning', 'Priority editing workflow', 'Best for launches and campaign-style social content'], image: 'https://images.pexels.com/photos/33410864/pexels-photo-33410864.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Built for brands that need scroll-stopping content for Instagram, TikTok, paid social, and web.' },
  { tabCategory: 'social-content', tabLabel: 'Social & Content', serviceSection: 'Headshots, Portraits & Studio Photography', name: 'Headshots & Portraits – Basic', price: '$395*', badge: '', includes: ['Up to 30 minutes', '1 look', '1 retouched final image', 'Private proof gallery'], image: 'https://images.pexels.com/photos/20230572/pexels-photo-20230572.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Professional, polished imagery for founders, teams, talent, and personal brands.' },
  ...
  { tabCategory: 'social-content', tabLabel: 'Social & Content', serviceSection: 'Headshots, Portraits & Studio Photography', name: 'Headshots & Portraits – Full Service', price: '$1,195*', badge: '', includes: ['Up to 90 minutes', '3 to 4 looks', '6 retouched final images', 'Creative direction throughout session', 'Priority turnaround'], image: 'https://images.pexels.com/photos/20230572/pexels-photo-20230572.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Professional, polished imagery for founders, teams, talent, and personal brands.' },
  // Events & Hospitality
  { tabCategory: 'events-hospitality', tabLabel: 'Events & Hospitality', serviceSection: 'Event Coverage', name: 'Event Coverage – Basic', price: '$850*', badge: '', includes: ['Up to 2 hours of coverage', '50+ edited images', 'Online gallery delivery'], image: 'https://images.pexels.com/photos/33721374/pexels-photo-33721374.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Refined event photography for launches, private gatherings, corporate events, dinners, and brand activations.' },
  { tabCategory: 'events-hospitality', tabLabel: 'Events & Hospitality', serviceSection: 'Event Coverage', name: 'Event Coverage – Standard', price: '$1,450*', badge: 'Most Popular', includes: ['Up to 4 hours of coverage', '125+ edited images', 'Online gallery delivery', 'Ideal for brand events, dinners, and networking events'], image: 'https://images.pexels.com/photos/33721374/pexels-photo-33721374.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Refined event photography for launches, private gatherings, corporate events, dinners, and brand activations.' },
  { tabCategory: 'events-hospitality', tabLabel: 'Events & Hospitality', serviceSection: 'Event Coverage', name: 'Event Coverage – Full Service', price: '$2,650*', badge: '', includes: ['Up to 8 hours of coverage', '250+ edited images', '24-hour preview selects', 'Full event storytelling coverage'], image: 'https://images.pexels.com/photos/33721374/pexels-photo-33721374.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Refined event photography for launches, private gatherings, corporate events, dinners, and brand activations.' },
  ...
  { tabCategory: 'events-hospitality', tabLabel: 'Events & Hospitality', serviceSection: 'Food Photography', name: 'Food Photography – Basic', price: '$950*', badge: '', includes: ['Up to 8 final edited images', '1 to 2 hero setups', 'Basic styling guidance'], image: 'https://images.pexels.com/photos/30469688/pexels-photo-30469688.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'High-end food and beverage imagery for restaurants, hospitality brands, menus, launches, and social campaigns.' },
  { tabCategory: 'events-hospitality', tabLabel: 'Events & Hospitality', serviceSection: 'Food Photography', name: 'Food Photography – Standard', price: '$1,650*', badge: 'Most Popular', includes: ['Up to 15 final edited images', '3 to 4 styled setups', 'Hero shots and detail shots', 'Ideal for seasonal updates and social content'], image: 'https://images.pexels.com/photos/30469688/pexels-photo-30469688.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'High-end food and beverage imagery for restaurants, hospitality brands, menus, launches, and social campaigns.' },
  { tabCategory: 'events-hospitality', tabLabel: 'Events & Hospitality', serviceSection: 'Food Photography', name: 'Food Photography – Full Service', price: '$2,850*', badge: '', includes: ['Up to 25 final edited images', '5 to 6 styled setups', 'Expanded art direction', 'Short motion clips or b-roll capture'], image: 'https://images.pexels.com/photos/30469688/pexels-photo-30469688.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'High-end food and beverage imagery for restaurants, hospitality brands, menus, launches, and social campaigns.' },
];
